...
MOVE_PACKAGE_PATH=../move/sixwoods
...
FOREST_ADMIN_CAP=$(echo "$newObjs" | jq -r 'select (.objectType | contains("single_player_sixwoods::ForestAdminCap")).objectId')
...
FOREST_ADMIN_CAP=$FOREST_ADMIN_CAP
API_ENV
